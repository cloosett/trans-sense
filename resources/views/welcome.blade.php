...
@section('content')
                ...
                <div class="owl-stage" style="transform: translate3d(-3762px, 0px, 0px); transition: all; width: 8778px;">
                    <div class="owl-item cloned" style="width: 1254px;">
                        <div class="slider-one__single">
                            ...
                            <div class="container">
                                <div class="slider-one__single-inner">
                                    <div class="slider-one__single-content">
                                        ...
                                        <div class="title-box">
                                            <h2>Ми надаємо<br><span>повний цикл доставки сипучих матеріалів</span></h2>
                                        </div>

                                        <div class="text-box">
                                            <p>Від кар’єру — до об'єкта. Професійний транспорт, точна логістика, якісний
                                                сервіс.</p>
                                        </div>
                    ...
                    <div class="about-one__img">
                        ...
                        <div class="about-one__img2">
                            ...
                            <div class="shape3 float-bob-y">
                                <img src="{{ asset('images/about-v1-shape3.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div> --}}
    ...
    <section class="why-choose-one">
        <div class="why-choose-one__pattern">
            <img src="{{ asset('images/why-choose-v1-pattern.png') }}" alt="">
        </div>
        <div class="shape1 float-bob-y"><img src="{{ asset('images/why-choose-v1-shape1.png') }}" alt=""></div>
        <div class="container">
            <div class="row">
